...
public abstract class AbstractEntityServiceBean<T extends AbstractEntity>
		implements IAbstractEntityService<T> , Serializable {
	...
	private final String save(final T entity) {
		...
		events.raiseEvent(	"com.mlink.iwm.persited." + entity.getClass().getSimpleName());
	...
	public String delete(final T entity) {
		...
		events.raiseEvent("com.mlink.iwm.deleted."+ entity.getClass().getSimpleName());
