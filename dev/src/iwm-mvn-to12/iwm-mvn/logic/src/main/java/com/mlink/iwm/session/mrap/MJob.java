...
public class MJob implements Serializable {
	...
	public void setTechnicians(List<AssetTimeShare> lats) {
	...
	public void setWorkItems(List<JobTask> ljt) {
		StringBuffer sb = new StringBuffer();
		for (JobTask jt : ljt) {
	...
	public static String getAttributeValue(Job job, String attrName) {
		if (attrName == null ||
			job == null ||
			job.getMaintainedAsset() == null) return "";
		List<AssetAttribute> saa = job.getMaintainedAsset().getAssetAttributes();
	...
	public static Asset getMaintainedAsset(Job job) {
		...
		return job.getMaintainedAsset();
	}
	public static String getAssetSerial(Job job) {
		if (job == null ||
			job.getMaintainedAsset() == null) return "";
		return job.getMaintainedAsset().getTag();
	}
