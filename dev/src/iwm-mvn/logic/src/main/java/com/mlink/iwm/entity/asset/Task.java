...
public class Task extends AbstractEntity{
	...
	private List<Asset> maintainedAssets; 
	...
	private List<NonAssetResource> nonAssetResources = new ArrayList<NonAssetResource>(0);;
	...
	private List<Asset> stickyAssetResources = new ArrayList<Asset>(0) ;
	...
	@OneToMany(cascade=CascadeType.ALL,fetch = FetchType.LAZY, mappedBy = "stickyToTask")
	public List<Asset> getStickyAssets() {
		return this.stickyAssetResources;
	}

	public void setStickyAssets(List<Asset> assets) {
		this.stickyAssetResources = assets;
	}

	@ManyToMany(mappedBy = "maintTasks")
	public List<Asset> getMaintainedAssets() {
		return this.maintainedAssets;
	}

	public void setMaintainedAssets(List<Asset> ma) {
