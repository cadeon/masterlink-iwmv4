...
public class JobManager implements Serializable {
	...
	public static String FOUO = "FOR OFFICIAL USE ONLY  Marine Corps ";
	public static String FOOTER = "IWM v4.0 MasterLink Corp.";
	public static String HEADLINE = "Manage Maintenance for 20000 H";
	public static boolean SET_FOOTER = false;
	...
	public Integer getNumShort()   { return numShort;	}
	...
	private void setFooter(MJob mj) {
		if ("M-ATV".equals(mj.getModel()) ||
		    "M1152".equals(mj.getModel()) ||
		    "M1151A1".equals(mj.getModel()) ||
		    "M1165".equals(mj.getModel()) ||
		    "AMK25".equals(mj.getModel()) ||
		    "CAT II RG33".equals(mj.getModel()) ||
		    "NK-27".equals(mj.getModel()) ||
		    "JERRV EOD 4X4".equals(mj.getModel()) ) {
			FOOTER = FOUO + FOOTER;
		}
		SET_FOOTER=true;
	}
	...
	public Float   getSchedulerRunTime() { 
		BigDecimal rt = new BigDecimal(scheduler.getSchedulerRunTime());
		BigDecimal bd = rt.divide(new BigDecimal(1000), 4, RoundingMode.HALF_UP); // convert milliseconds to seconds
		return bd.floatValue();
	}
	public Float   getSchedulerUtility() { return scheduler.getSchedulerUtility().floatValue(); }
	public Long    getSchedulerTotalSchedules() { return scheduler.getSchedulerTotalSchedules(); }
	public Long    getSchedulerTotalLegalSchedules() { return scheduler.getSchedulerTotalLegalSchedules(); }
	public Boolean getSchedulerRunComplete() { return scheduler.getSchedulerRunComplete(); }
	...
	public String onJobRowClicked() {
		...
		taskInstanceHome.setInstance(jobHome.getInstance().getTaskInstance());
