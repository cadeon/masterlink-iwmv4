...
import org.mlink.agents.scheduler.testSupport.SchedulerProbabilisticDataGenerator;
 ...
 */
	...
	// Larger tests of happy path - contain println() statements	
	...
	public void testMediumInputHasNoProcessingErrorsFromSID() throws IOException {
		...
		Assert.assertEquals("HC Happy Path: No errors on good input", sod.getProcessingErrors().size(), 0);
		System.out.println("Number of timeshares is 9 " + sod.getAssetTimeShares().size() + " utility is 0.035433296 " + sod.getUtility() + " time " + sod.getRunTime()/1000F + " seconds ");
	}
	...
	public void testBigInputHasNoProcessingErrorsFromFile() throws IOException {
		...
		Assert.assertEquals("HC Happy Path: No errors on good input", sod.getProcessingErrors().size(), 0);
		System.out.println("Number of timeshares is 33 " + sod.getAssetTimeShares().size() + " utility  is 0.052416485 " + sod.getUtility()
				+ " time " + sod.getRunTime()/1000F + " seconds ");
	}
	...
	public void testSmallInputDuplicateJobDoesNotLowerUtilityFromFile() throws IOException {
		...
		System.out.println(" orig " + originalUtility + " dup " + dupUtility + " lower " + fitsUtility);
...
/*
	public void testBigger35InputHasNoProcessingErrorsFromFile() throws IOException {
		...
		Assert.assertEquals("HC Happy Path: No errors on good input", sod.getProcessingErrors().size(), 0);
		System.out.println("Number of timeshares is 117 " + sod.getAssetTimeShares().size() + " utility  is 0.5196488 " + sod.getUtility()
				+ " time is 21.791 seconds " + sod.getRunTime()/1000F + " seconds ");
	}
*/	
...
/*
	public void testBiggerInputHasNoProcessingErrorsFromFile() throws IOException {
		...
		Assert.assertEquals("HC Happy Path: No errors on good input", sod.getProcessingErrors().size(), 0);
		System.out.println("Number of timeshares is 83 " + sod.getAssetTimeShares().size() + " utility  is 0.16515738 " + sod.getUtility()
				+ " time is 22.66 seconds " + sod.getRunTime()/1000F + " seconds ");
	}
*/	
