...
class SODFileOutputGenerator {
	...
	static void processOutputFile(SchedulingOutputData sod, String filnam)   throws IOException {
		String delim = " ";	
	...
	static void processFatalOutputFile(SchedulingOutputData sod, String filnam) throws IOException {
		String delim = " ";	
		Date date = new Date();
