...
public class Asset {
	...
	public void setAvailabilities(List<AssetAvailability> avail) {availabilities = avail;}
	...
	public void setAssetAttributes(List<AssetAttribute> avail) {attributes = avail;}
	public void addAssetAttributes(AssetAttribute aa) {
		if (attributes==null) attributes=new ArrayList<AssetAttribute>();
		attributes.add(aa);
	}
	public void setAsseProficiencies(List<Proficiency> avail) {proficiencies = avail;}
