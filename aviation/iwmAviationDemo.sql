...
INSERT INTO `Job` (`jobId`,`archiveDate`,`lastChange`,`jobCat`,`dueDate`,`completedDate`,`createdBy`,`createdDate`,`dis`,`description`,`dispatchedDate`,`earliestStart`,`eom`,`ero`,`estTime`,`jobType`,`latestStart`,`note`,`priority`,`risd`,`scheduledDate`,`startedDate`,`status`,`sticky`,`totatEstTime`,`orgId`)
VALUES
