...
public class Scheduler implements Serializable {
	...
	public MetaData createMetaData(){
		...
		md.setConversionFactor((long) 60000); //everything is in mills.
		...
		if (errs.size() > 0){
			for (int e=0; e<errs.size(); e++){
				...
				if (thisError.getSeverity() == 2 || thisError.getSeverity() == 3){
					...
					System.out.println("Scheduler said "+ thisError.toString());
				}
			}
		}
		//What's done is done
	...
	/*
	 * Validation of input data happens in the scheudler,
