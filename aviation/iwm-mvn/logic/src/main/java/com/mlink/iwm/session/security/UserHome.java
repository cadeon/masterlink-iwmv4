...
public class UserHome extends EntityHome<User> {
	...
	public User findUserByUid(String useruid) {
		...
		log.info(">>>>>>>> findUserByUid(){0}: ", useruid);
		try {
			...
			log.info(">>>>>>>> findUserByUid() user {0} not found", useruid);
		} catch (Exception ex) {
			log.info(">>>>>>>> findUserByUid() exception " + ex.getMessage());
		}
	...
	public User findUser(String emailAdr) {
		...
		try {
			...
			log.info(">>>>>>>> findUserByEmail()email {0} not found", emailAdr);

		} catch (Exception ex) {
			log.info(">>>>>>>> findUserByEmail() exception " + ex.getMessage());
		}
		return user;
	}
	...
	public User findUser(String email, String uid) {
		...
		try {
			...
			log.info(">>>>>>>> findUser(String email, String uid)"
					+ ex.getMessage());
		}
		return user;
	}
