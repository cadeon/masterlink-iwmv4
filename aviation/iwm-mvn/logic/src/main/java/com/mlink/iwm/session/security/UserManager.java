...
public class UserManager {
	...
	public String changePassword(){
		...
		log.info(">>>>>>>>>>User found passwd is: {0}", user.getPassword());
		log.info(">>>>>>>>>>input current pswd {0}: ", userHome.getInstance().getCurrentpswd());
		...
		log.info(">>>>>>>>>>Current and input pswds match");
